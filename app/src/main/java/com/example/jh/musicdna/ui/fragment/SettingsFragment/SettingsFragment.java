package com.example.jh.musicdna.ui.fragment.SettingsFragment;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        resetSettings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alertDialog.setTitle(getString(R.string.isReset_settings));
                // This operation will reset all settings but playlist and other content will remain unchanged.
                ...
                alertDialog.setButton(android.app.AlertDialog.BUTTON_POSITIVE, "重置",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                resetAllSettings();
                                Toast.makeText(getContext(), "重置设置成功", Toast.LENGTH_LONG).show();
                            }
                        });
